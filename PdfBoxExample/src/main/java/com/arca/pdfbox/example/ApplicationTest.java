...
public class ApplicationTest {
	...
	public static void main(String[] args) throws IOException,
		...
		if (pdfString.contains("CONTO CORRENTE DI PIPPO")
				&& pdfString.contains("11,00") && pdfString.contains("12,00")
				&& pdfString.contains("XXXXXXXXXX")
				&& pdfString.contains("PIPPO CLIENTE")){
